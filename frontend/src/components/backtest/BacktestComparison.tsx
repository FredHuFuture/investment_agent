          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg bg-gray-800 border border-gray-700 text-gray-200 text-sm px-3 py-2 focus:ring-2 focus:ring-accent focus:border-accent"
            ...
            <table className="w-full text-sm" data-testid="comparison-metrics-table">
              <thead>
                <tr className="border-b border-gray-800/50">
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-accent-light uppercase tracking-wider">
                    Run A
                  </th>
