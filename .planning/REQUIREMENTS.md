...
- [x] **CLOSE-04**: Close Phase 4 human-UAT — target-weight browser flow (set, persist on reload, clear, invalid-input alert). Document in `04-HUMAN-UAT.md`.
- [x] **CLOSE-05**: Close Phase 4 human-UAT — MonitoringPage rules panel (toggle STOP_LOSS_HIT off, confirm daemon log excludes it on next run). Document in `04-HUMAN-UAT.md`.
- [x] **CLOSE-06**: Close Phase 4 human-UAT — DailyPnlHeatmap tooltip on hover with date + P&L + correct color. Document in `04-HUMAN-UAT.md`.
