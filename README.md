...
[![Python 3.11+](https://img.shields.io/badge/Python-3.11%2B-blue)](https://python.org) [![License MIT](https://img.shields.io/badge/License-MIT-green)](LICENSE) [![Tests 772 passing](https://img.shields.io/badge/Tests-772_passing-brightgreen)](#) [![Pages 14](https://img.shields.io/badge/Pages-14-blue)](#) [![FastAPI](https://img.shields.io/badge/API-FastAPI-009688)](http://localhost:8000/docs)
...
investment_agent/
  ...
  api/              # FastAPI REST backend (57 endpoints)
  ...
  tests/            # 772+ tests (465 backend + 307 frontend)
```
