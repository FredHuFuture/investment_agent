...
investment_agent/
  ...
  api/              # FastAPI REST backend (76 endpoints)
  frontend/         # React 18 + TypeScript + Tailwind dashboard (15 pages, 39+ UI components)
