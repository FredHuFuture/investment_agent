...
[![Python 3.11+](https://img.shields.io/badge/Python-3.11%2B-blue)](https://python.org) [![License MIT](https://img.shields.io/badge/License-MIT-green)](LICENSE) [![Tests 881 passing](https://img.shields.io/badge/Tests-881_passing-brightgreen)](#) [![Pages 15](https://img.shields.io/badge/Pages-15-blue)](#) [![FastAPI](https://img.shields.io/badge/API-FastAPI-009688)](http://localhost:8000/docs)
...
investment_agent/
  ...
  api/              # FastAPI REST backend (~90 endpoints)
  frontend/         # React 18 + TypeScript + Tailwind dashboard (15 pages, 57+ UI components)
  ...
  tests/            # 881+ tests (517 backend + 364 frontend)
```
